...
function registerOptions()
	...
	OptionsManager.registerOption2("BLOOD",false, "option_header_overlays", "option_label_BLOOD", "option_entry_cycler", 
		{ labels = "option_val_injury|option_val_blood25|option_val_blood50|option_val_blood75|option_val_blood100", 
			values = "injury|25|50|75|100", baselabel = "option_val_off", baseval = "off", default = "off" });
end
