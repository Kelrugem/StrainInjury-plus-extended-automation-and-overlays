...
function applyDamage(rSource, rTarget, bSecret, sRollType, sDamage, nTotal, bImmune, bFortif, tags)
	...
	-- Damage
		...
		local nDamageAdjust, nNonlethalDmgAmount, bVulnerable, bResist, aInjury = ActionDamage.getDamageAdjust(rSource, rTarget, rDamageOutput.nVal, rDamageOutput, bImmune, bFortif, tags);
		if aInjury then
